...
这套文档现在位于 `DejaVu/.context/`，是 `DejaVu` 这一侧的唯一正式文档入口。

目标不是逐段翻译，而是让你遇到问题时更快定位。

## 建议阅读顺序

1. `00_project_overview.md`
2. `01_shared_protocol.md`
3. `03_color_conventions.md`
...
- 协议、颜色、矩阵语义先看本目录的 `01_shared_protocol.md` 和 `03_color_conventions.md`。
