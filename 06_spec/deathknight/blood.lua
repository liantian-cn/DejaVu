...
insert(macroList, { title = "target迎头痛击", key = "ALT-NUMPAD9", text = "/cast [@target] 迎头痛击" })
insert(macroList, { title = "focus迎头痛击", key = "ALT-NUMPAD0", text = "/cast [@focus] 迎头痛击" })
insert(macroList,
       {
           title = "就近灵界打击",
           key = "SHIFT-NUMPAD1",
...
insert(macroList, { title = "mouseover枯萎凋零", key = "SHIFT-NUMPAD4", text = "/cast [@cursor] 枯萎凋零" })
